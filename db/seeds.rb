...
languages = Category.create!(name: 'languages', photo_url: 'https://images.unsplash.com/photo-1584743579123-25274517da76?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2515&q=80')
...
decks << deck_6 = Deck.create!(name: 'How life works', user: user, category: chemistry)
decks << deck_7 = Deck.create!(name: 'How cars work', user: user, category: chemistry)
decks << deck_8 = Deck.create!(name: 'How I spent the end of my life', user: user, category: chemistry)
decks << deck_9 = Deck.create!(name: 'Coffee and ciggarets', user: user, category: chemistry)
decks << deck_10 = Deck.create!(name: 'Random 3', user: user, category: languages)
decks << deck_11 = Deck.create!(name: 'Random 4', user: user, category: languages)
decks << deck_12 = Deck.create!(name: 'How chairs are made', user: user, category: languages)
decks << deck_13 = Deck.create!(name: 'Cotton candy', user: user, category: languages)
decks << deck_14 = Deck.create!(name: 'Crew Hassan', user: user, category: languages)
...
decks << deck_18 = Deck.create!(name: 'Keyboard for dummies', user: user, category: history)
...
decks << deck_26 = Deck.create!(name: 'Category test', user: user, category: others)
